...
const ClientTestimonialForm = ({
  ...
  const isEditMode = !!testimonialData;
  ...
  useEffect(() => {
    if (testimonialData && isOpen) {
      setFormData({
        ...
        slideOrder: testimonialData.slideOrder,
        isActive: testimonialData.isActive,
        image: null,
      });
      setPreviewImage(testimonialData.image);
    } else {
  ...
  const handleSubmit = (e) => {
    ...
    const action = isEditMode
      ? updateTestimonial({ id: testimonialData.id, formData: apiFormData })
      : createTestimonial(apiFormData);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full border rounded p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500"
          ...
          <div className="border-2 border-dashed p-4 rounded bg-gray-50 text-center">
            ...
            {previewImage && (
              <img
                src={previewImage}
                alt="Client Preview"
                className="mx-auto h-24 w-24 object-cover rounded-full border shadow-md"
              />
            )}
          </div>
