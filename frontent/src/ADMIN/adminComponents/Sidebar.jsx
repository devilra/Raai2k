...
const Sidebar = () => {
  ...
  return (
    ...
    <div className="fixed top-0 left-0 h-screen w-64 bg-gray-900 text-white p-4 z-20 shadow-2xl flex flex-col justify-between">
      <div>
        <h2 className="text-2xl font-extrabold mb-8 text-blue-400 border-b border-gray-700 pb-3">
          Admin
        </h2>
