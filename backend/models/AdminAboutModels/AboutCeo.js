...
const CeoMessage = sequelize.define(
  "CeoMessage",
  {
    id: {
    ...
    // 1. 🔹 தலைப்பு (உதாரணம்: Message From CEO)
    title: {
    ...
    // 3. 👤 CEO பெயர் (புதிய Key - உதாரணம்: KARTHI NAT)
    ceoName: {
      type: DataTypes.STRING(100),
      allowNull: false,
    },

    // 4. 💼 பதவி/பொறுப்பு (புதிய Key - உதாரணம்: Founder, RAAi2K)
    ceoPosition: {
      type: DataTypes.STRING(150),
      allowNull: false,
    },

    // 5. 🖼️ CEO படம் (Avatar/Photo URL)
    image: {
  ...
  {
    tableName: "ceo_message", // Database-இல் உள்ள அட்டவணைப் பெயர் (Table Name)
