...
const AdminAuth = sequelize.define(
  "AdminAuth",
  {
    ...
    email: {
      ...
      allowNull: false,
      // unique: true, // ⚠️ Column definition-க்குள்ளேயே Unique Constraint கொடுக்கப்படவில்லை (Options block-இல் index-ஆக கொடுக்கப்பட்டுள்ளது)
      validate: {
        isEmail: true,
      },
    },
  ...
  {
    timestamps: true, // createdAt and updatedAt fields-ஐ தானாக சேர்க்கும்
    tableName: "AdminAuth",
    // ✅ Email-ஐ Unique ஆகவும், Index-ஆகவும் அமைக்கப்படுகிறது
    indexes: [
      {
        unique: true,
